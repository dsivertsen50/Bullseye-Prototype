...
{
    internal sealed class UAnimationUtility
    {
        public delegate void KeyTangentModeSetter(ref Keyframe key, AnimationUtility.TangentMode tangentMode);
        public delegate void KeyBrokenSetter(ref Keyframe key, bool broken);
        ...
        private readonly KeyTangentModeSetter dg_SetKeyLeftTangentMode;
        private readonly KeyTangentModeSetter dg_SetKeyRightTangentMode;
        private readonly KeyBrokenSetter dg_SetKeyBroken;
        ...
        {
            var animationUtilityType = ReflectionCommon.GetUnityEditorType("UnityEditor.AnimationUtility");
            ...
            Assert.IsNotNull(dg_SetKeyLeftTangentMode = (KeyTangentModeSetter)Delegate.CreateDelegate(typeof(KeyTangentModeSetter), null, animationUtilityType.GetMethod("SetKeyLeftTangentMode", BindingFlags.NonPublic | BindingFlags.Static)));
            Assert.IsNotNull(dg_SetKeyRightTangentMode = (KeyTangentModeSetter)Delegate.CreateDelegate(typeof(KeyTangentModeSetter), null, animationUtilityType.GetMethod("SetKeyRightTangentMode", BindingFlags.NonPublic | BindingFlags.Static)));
            Assert.IsNotNull(dg_SetKeyBroken = (KeyBrokenSetter)Delegate.CreateDelegate(typeof(KeyBrokenSetter), null, animationUtilityType.GetMethod("SetKeyBroken", BindingFlags.NonPublic | BindingFlags.Static)));
        ...
        public void UpdateTangentsFromModeSurrounding(AnimationCurve curve, int index) => dg_UpdateTangentsFromModeSurrounding(curve, index);
        public void SetKeyLeftTangentMode(ref Keyframe key, AnimationUtility.TangentMode tangentMode) => dg_SetKeyLeftTangentMode(ref key, tangentMode);
        public void SetKeyRightTangentMode(ref Keyframe key, AnimationUtility.TangentMode tangentMode) => dg_SetKeyRightTangentMode(ref key, tangentMode);
        public void SetKeyBroken(ref Keyframe key, bool broken) => dg_SetKeyBroken(ref key, broken);
