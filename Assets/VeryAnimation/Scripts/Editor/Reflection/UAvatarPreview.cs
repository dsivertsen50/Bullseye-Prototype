...
{
    internal sealed class UAvatarPreview : IDisposable
    {
        ...
        private readonly Func<object, Motion> dg_get_m_SourcePreviewMotion;
        ...
        private class UAvatarPreviewSelection
        {
            ...
            public UAvatarPreviewSelection()
            {
                var avatarPreviewSelectionType = ReflectionCommon.GetUnityEditorType("UnityEditor.AvatarPreviewSelection");
        ...
        class GUIStyles
        {
            public readonly GUIContent guiContentRootMotion;
            public readonly GUIContent guiContentAnimationRigging;
            public readonly GUIContent guiContentLayers;

            public GUIStyles()
            {
                guiContentRootMotion = new GUIContent("Root Motion", "Apply Root Motion");
                guiContentAnimationRigging = new GUIContent("Animation Rigging", "Animation Rigging Constraint");
                guiContentLayers = new GUIContent("Layers", "Animator Controller Layers");
            }
        }
        ...
        {
            var avatarPreviewType = ReflectionCommon.GetUnityEditorType("UnityEditor.AvatarPreview");
            ...
            Assert.IsNotNull(dg_set_fps = ReflectionCommon.CreateSetFieldDelegate<int>(avatarPreviewType.GetField("fps")));
            Assert.IsNotNull(dg_get_m_SourcePreviewMotion = ReflectionCommon.CreateGetFieldDelegate<Motion>(avatarPreviewType.GetField("m_SourcePreviewMotion", BindingFlags.NonPublic | BindingFlags.Instance)));
            ...
            uAvatarPreviewSelection = new UAvatarPreviewSelection();
        ...
        private void InitController()
        {
            ...
            else
            {
                ...
                var ac = AnimationCommon.GetAnimatorController(originalAnimator);
                if (layerClips != null && ac != null && isLayersflag)
                {
                    var layers = ac.layers;
                    var stopTime = GetStopTime();
                    m_AnimationLayerMixerPlayable = AnimationLayerMixerPlayable.Create(m_PlayableGraph, layers.Length);
        ...
        public void OnPreviewSettings()
        {
            ...
            if (!clip.legacy && animator != null)
            {
                ...
                flag = GUILayout.Toggle(flag, Styles.guiContentRootMotion, EditorStyles.toolbarButton);
            ...
            if (m_RigBuilder != null)
            {
                ...
                EditorGUI.BeginChangeCheck();
                flag = GUILayout.Toggle(flag, Styles.guiContentAnimationRigging, EditorStyles.toolbarButton);
                if (EditorGUI.EndChangeCheck())
                {
            ...
            if (layerClips != null && originalAnimator != null)
            {
                ...
                if (ac != null)
                {
                    ...
                    EditorGUI.BeginChangeCheck();
                    flag = GUILayout.Toggle(flag, Styles.guiContentLayers, EditorStyles.toolbarButton);
                    if (EditorGUI.EndChangeCheck())
                    {
        ...
        public void OnGUI(Rect r, GUIStyle background)
        {
            ...
            if (animator != null && animator.applyRootMotion && transformPoseSave != null)
            {
                ...
                EditorGUI.DropShadowLabel(rect, $"Root Motion Position {pos}\nRoot Motion Rotation {rot}");
            }
        }
        ...
        private bool IsIKOnFeet => dg_get_ShowIKOnFeetButton() && dg_get_IKOnFeet();
        ...
        private AnimationClip GetClip() => (AnimationClip)dg_get_m_SourcePreviewMotion(Instance);
    }
}
