...
{
    [Serializable]
    internal sealed class MuscleGroupTree
    {
        ...
        private const string PrefKey_MuscleGroupMode = "VeryAnimation_MuscleGroupMode";
        ...
        class GUIStyles
        {
            ...
            public readonly string[] muscleGroupModeString =
            {
                nameof(MuscleGroupMode.Category),
                nameof(MuscleGroupMode.Part),
            };
        }
        ...
        public MuscleGroupTree()
        {
            #region MuscleGroupNode
            {
                ...
                {
#region Category
                    new() { name = nameof(MuscleGroupMode.Category),
...
#endregion
#region Part
                    new() { name = nameof(MuscleGroupMode.Part),
                        children = new MuscleGroupNode[]
                        {
#region Face
                            new() { name = "Face",
...
#region Right Little
        ...
        {
            muscleGroupMode = (MuscleGroupMode)EditorPrefs.GetInt(PrefKey_MuscleGroupMode, 0);
        }
        public void SaveEditorPref()
        {
            EditorPrefs.SetInt(PrefKey_MuscleGroupMode, (int)muscleGroupMode);
        }

        public void MuscleGroupTreeToolbarGUI()
        {
            EditorGUI.BeginChangeCheck();
            var m = (MuscleGroupMode)GUILayout.Toolbar((int)muscleGroupMode, Styles.muscleGroupModeString, EditorStyles.miniButton);
        ...
        public void MuscleGroupTreeGUI()
        {
            ...
            EditorGUILayout.BeginVertical(VAW.GuiStyleSkinBox);
            {
                ...
                #region Top
                {
                    ...
                    {
                        void AppendAllHumanoidBones(ICollection<GameObject> goCol, ICollection<HumanBodyBones> virtualCol)
                        {
                        ...
                        if (Shortcuts.IsKeyControl(e) || e.shift)
                        {
                            ...
                            AppendAllHumanoidBones(combineGoList, combineVirtualList);
                    ...
                    if (GUILayout.Button("Root", GUILayout.Width(100)))
                    {
                        if (Shortcuts.IsKeyControl(e) || e.shift)
                        {
                            ...
                            VAW.VA.SelectGameObjects(combineGoList, VAW.VA.SelectionHumanVirtualBones);
                        }
                        else
                        {
                ...
                }
                {
                    ...
                    if (EditorGUI.EndChangeCheck())
                    {
                        ...
                        if (VAW.VA.optionsMirror)
                        {
                            ...
                            if (mirrorNode != null)
                                SetMuscleGroupValue(mirrorNode, value, null);
                        }
                    }
